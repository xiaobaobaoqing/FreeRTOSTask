...
/* 头文件 */
#ifdef __CC_ARM                         // 仅在使用 ARM 编译器（Keil MDK / ARMCLANG）时生效
...
#define configMAX_CO_ROUTINE_PRIORITIES         2           /* 定义协程的最大优先级,最大优先级=configMAX_CO_ROUTINE_PRIORITIES-1 */
...
#define INCLUDE_vTaskCleanUpResources           1       /* 清除任务资源 */
#define INCLUDE_vTaskSuspend                    1       /* 挂起任务 */
#define INCLUDE_vTaskResume                     1       /* 恢复任务 */
#define INCLUDE_vTaskResumeFromISR              1       /* 恢复在中断中挂起的任务 */
...
//#define xPortSysTickHandler   SysTick_Handler   /* HAL库接管SysTick，注释 */

/* 断言 */
#define configASSERT( x ) if( ( x ) == 0 ) { taskDISABLE_INTERRUPTS(); for( ;; ); }

/* FreeRTOS MPU 特殊定义,F411无MPU全部注释 */
...
//#define configASSERT_VALID_INTERRUPT_PRIORITY                   0
